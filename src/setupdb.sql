...
insert into HealthcareProfessional values (55544, 'Joel', 'Lewis', '306', '1081 Burrard St', 'V6Z1Y6', '604-713-2291', '604-682-2344 x306');
...
insert into HealthcareProfessional values (55511, 'Aaron', 'Miller', '', '2685 W Broadway', 'V6Z1Y6', '604-775-3021', '604-882-4038');
insert into HealthcareProfessional values (55522, 'James', 'Yu', '', '200-2475 Bayswater St', 'V6H3N1', '604-668-4522', '604-565-2111');
insert into HealthcareProfessional values (55533, 'Alex', 'Chen', '200', '1755 1st Ave W', 'V6K2G2', '604-668-8323', '604-788-6569');
...
insert into Doctor values (55544, 922789, 'Cardiologist');
...
insert into Doctor values (55511, 932111, 'Family Doctor');
insert into Doctor values (55522, 926433, 'Family Doctor');
insert into Doctor values (55533, 985744, 'Family Doctor');
...
insert into HealthcareProfessional values (51111, 'Grace', 'Wong', NULL, '6060 Minoru Blvd', 'V6Y2V7', '604-668-2187', '604-273-6187');
...
insert into HealthcareProfessional values (52222, 'Joseph', 'Harris', '', '3713 Kensington Ave', 'V5B0A7', '604-722-4983', '604-985-4928');
insert into HealthcareProfessional values (58574, 'Gideon', 'Fay', 'Unit 120', 'Glenlyon Pkwy', 'V5J0B6', '604-663-3841', '775-398-3958');
insert into HealthcareProfessional values (53333, 'Sumathi', 'Gudapati', 'Unit 120', 'Glenlyon Pkwy', 'V5J0B6', '604-984-3843', '775-294-8243');
insert into HealthcareProfessional values (58576, 'Garry', 'Henderson', '#203', '6542 Hastings St.', 'V5B1S2', '604-945-2943', '250-839-9284');

insert into Pharmacist values (51111, 767332);
...
insert into Pharmacist values (52222, 724853);
insert into Pharmacist values (58574, 768345);
insert into Pharmacist values (53333, 795735);
...
insert into HealthcareProfessional values (55333, 'Vanya', 'Preet', '112','3540 W 41st Ave', 'V6X4J7', '604-731-2411', '1-800-431-7206');
insert into HealthcareProfessional values (57564, 'Lynn', 'Nelson', '306', '4827 Kingsway', 'V5H4T6', '604-774-3943', '604-927-3858');
insert into HealthcareProfessional values (55222, 'Mandy', 'Karim', '306', '4827 Kingsway', 'V5H4T6', '604-765-3958', '604-927-3743');
insert into HealthcareProfessional values (55111, 'Colleen', 'Kirkham', '306', '4500 Still Creek Dr', 'V5C0B5', '604-713-5837', '250-385-3958');
...
insert into LabTechnician values (55333, 896264);
insert into LabTechnician values (57564, 837444);
insert into LabTechnician values (55222, 829485);
insert into LabTechnician values (55111, 828475);
insert into LabTechnician values (56328, 848673);
insert into LabTechnician values (57831, 849582);

insert into Patient values (31000000, 'Tony', 'Liu', '15388 24th Ave', 'V3V6H2', '778-348-5834', '250-865-3853');
insert into Patient values (32000000, 'Simon', 'Gaur', '10777 University Dr.', 'V3V6H2', NULL, NULL);
insert into Patient values (33000000, 'Barry', 'Lam', NULL, NULL, '778-485-2834', '250-865-3853');
insert into Patient values (34000000, 'Vince', 'Lao', '7155 Hall Rd', 'V3V6A8', NULL, '250-865-3853');
...
insert into Referral values (32118954, 52918, 55544, TO_DATE('2019-02-21', 'YYYY-MM-DD'));
...
insert into Referral values (12345678, 52918, 55544, TO_DATE('2019-02-21', 'YYYY-MM-DD'));
insert into Referral values (31000000, 55511, 55544, TO_DATE('2019-01-15', 'YYYY-MM-DD'));
insert into Referral values (31000000, 55511, 56483, TO_DATE('2017-11-17', 'YYYY-MM-DD'));
insert into Referral values (31000000, 55511, 58572, TO_DATE('2018-08-15', 'YYYY-MM-DD'));
insert into Referral values (32000000, 55522, 53596, TO_DATE('2018-06-13', 'YYYY-MM-DD'));
insert into Referral values (32000000, 55522, 56868, TO_DATE('2018-02-22', 'YYYY-MM-DD'));
insert into Referral values (32000000, 55522, 56992, TO_DATE('2019-03-11', 'YYYY-MM-DD'));
insert into Referral values (34000000, 55533, 55544, TO_DATE('2019-03-11', 'YYYY-MM-DD'));
insert into Referral values (34000000, 55533, 51837, TO_DATE('2018-10-09', 'YYYY-MM-DD'));
...
insert into Prescription values (452855, 'Albuterol', 25, 100, 32118954, 55544, 55246, TO_DATE('2018-09-11','YYYY-MM-DD'), TO_DATE('2018-09-13','YYYY-MM-DD'));
...
insert into Prescription values (472596, 'Pregabalin', 85, 1, 12345678, 52918, 51111, TO_DATE('2018-03-15','YYYY-MM-DD'), TO_DATE('2018-03-21','YYYY-MM-DD'));
insert into Prescription values (492845, 'Fluticasone', 15, 100, 12345678, 52918, 51111, TO_DATE('2018-04-26','YYYY-MM-DD'), TO_DATE('2018-05-01','YYYY-MM-DD'));
insert into Prescription values (472947, 'Pregabalin', 85, 1, 31857372, 52918, 51111, TO_DATE('2018-03-15','YYYY-MM-DD'), TO_DATE('2018-03-21','YYYY-MM-DD'));
insert into Prescription values (427437, 'Fluticasone', 15, 100, 31274656, 52918, 51111, TO_DATE('2018-04-26','YYYY-MM-DD'), TO_DATE('2018-05-01','YYYY-MM-DD'));
insert into Prescription values (438477, 'Amoxicillin', 25, 100, 34000000, 55511, 52222, TO_DATE('2019-01-05','YYYY-MM-DD'), TO_DATE('2019-01-06','YYYY-MM-DD'));
insert into Prescription values (445873, 'Fluoxetine', 20, 200, 34000000, 55511, 52222, TO_DATE('2018-10-03','YYYY-MM-DD'), TO_DATE('2018-10-03','YYYY-MM-DD'));
insert into Prescription values (427483, 'Levothyroxine', 15, 150, 34000000, 55511, 58574, TO_DATE('2018-06-19','YYYY-MM-DD'), TO_DATE('2018-06-19','YYYY-MM-DD'));
insert into Prescription values (495872, 'Fluticasone', 35, 75, 34000000, 55511, NULL, TO_DATE('2017-08-16','YYYY-MM-DD'), TO_DATE('2017-08-16','YYYY-MM-DD'));
insert into Prescription values (431734, 'Metformin', 25, 30, 32000000, 55522, NULL, TO_DATE('2019-03-25','YYYY-MM-DD'), NULL);
insert into Prescription values (459382, 'Levothyroxine', 15, 100, 32000000, 55522, 53333, TO_DATE('2019-01-26','YYYY-MM-DD'), TO_DATE('2019-01-31','YYYY-MM-DD'));
insert into Prescription values (448582, 'Lisinopril', 20, 200, 32000000, 55522, 53333, TO_DATE('2018-10-01','YYYY-MM-DD'), TO_DATE('2018-10-06','YYYY-MM-DD'));
insert into Prescription values (433853, 'Pregabalin', 20, 300, 33000000, 55533, NULL, TO_DATE('2018-04-15','YYYY-MM-DD'), NULL);
insert into Prescription values (429384, 'Simvastatin', 30, 50, 33000000, 55533, NULL, TO_DATE('2019-03-12','YYYY-MM-DD'), NULL);
insert into Prescription values (448273, 'Lipitor', 5, 100, 33000000, 55533, NULL, TO_DATE('2018-03-11','YYYY-MM-DD'), NULL);
insert into Prescription values (483840, 'Fluoxetine', 5, 100, 33000000, 55533, NULL, TO_DATE('2018-03-11','YYYY-MM-DD'), NULL);
insert into Prescription values (438539, 'Esomeprazole', 5, 100, 33000000, 55533, NULL, TO_DATE('2018-03-11','YYYY-MM-DD'), NULL);
...
insert into LabTest values (830485, 155.7, 85.7, 70.0, 113.2, 2.36, 3.58, 39.7, 173, 23.3, 0.70, 140, 3.7, 140.6, 12345678, 52918, 55333, TO_DATE('2018-11-05', 'YYYY-MM-DD'), TO_DATE('2018-11-06', 'YYYY-MM-DD'));
...
insert into LabTest values (883747, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 31000000, 55544, NULL, TO_DATE('2019-03-21', 'YYYY-MM-DD'), NULL);
insert into LabTest values (837563, 179.8, 67.5, 93.0, 102.5, 2.16, 3.49, 43.8, 190, 24.7, 0.81, 133, 3.7, 138.2, 31000000, 55511, 55333, TO_DATE('2018-12-21', 'YYYY-MM-DD'), TO_DATE('2019-01-03', 'YYYY-MM-DD'));
insert into LabTest values (848281, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 32000000, 55522, NULL, TO_DATE('2019-03-11', 'YYYY-MM-DD'), NULL);
insert into LabTest values (847850, 183.3, 81.1, 97.8, 103.6, 2.15, 3.44, 42.1, 192, 23.6, 0.76, 138, 3.7, 133.6, 32000000, 55522, 55222, TO_DATE('2018-04-16', 'YYYY-MM-DD'), TO_DATE('2018-04-17', 'YYYY-MM-DD'));
insert into LabTest values (847370, 184.1, 81.4, 100.2, 100.0, 2.17, 3.46, 42.7, 192, 23.9, 0.78, 132, 3.7, 133.6, 32000000, 55522, 55111, TO_DATE('2018-11-03', 'YYYY-MM-DD'), TO_DATE('2018-11-10', 'YYYY-MM-DD'));
insert into LabTest values (827475, 165.0, 70.8, 93.0, 96.7, 2.15, 3.75, 42.0, 186, 22.3, 0.66, 138, 3.6, 121.2, 34000000, 55533, 57831, TO_DATE('2018-08-14', 'YYYY-MM-DD'), TO_DATE('2018-08-20', 'YYYY-MM-DD'));
...
insert into ProvincialHealthPlan values (128471, 'BC Resident - MSP', TO_DATE('2018-01-01','YYYY-MM-DD'), TO_DATE('2019-12-31','YYYY-MM-DD'), 31000000);
insert into ProvincialHealthPlan values (124772, 'BC Resident - MSP', TO_DATE('2018-01-01','YYYY-MM-DD'), TO_DATE('2019-12-31','YYYY-MM-DD'), 32000000);
insert into ProvincialHealthPlan values (124324, 'BC Resident - Income Assistance', TO_DATE('2019-01-01','YYYY-MM-DD'), TO_DATE('2019-12-31','YYYY-MM-DD'), 33000000);
insert into ProvincialHealthPlan values (128472, 'BC Resident - Premium MSP', TO_DATE('2019-01-01','YYYY-MM-DD'), TO_DATE('2019-12-31','YYYY-MM-DD'), 34000000);
insert into ProvincialHealthPlan values (128999, 'BC Resident - MSP', TO_DATE('2018-01-01','YYYY-MM-DD'), TO_DATE('2019-12-31','YYYY-MM-DD'), 31857372);
insert into ProvincialHealthPlan values (120071, 'BC Resident - MSP', TO_DATE('2018-01-01','YYYY-MM-DD'), TO_DATE('2019-12-31','YYYY-MM-DD'), 32485737);
insert into ProvincialHealthPlan values (128461, 'BC Resident - MSP', TO_DATE('2018-01-01','YYYY-MM-DD'), TO_DATE('2019-12-31','YYYY-MM-DD'), 31572742);
insert into ProvincialHealthPlan values (129372, 'BC Resident - MSP', TO_DATE('2018-01-01','YYYY-MM-DD'), TO_DATE('2019-12-31','YYYY-MM-DD'), 38577324);
insert into ProvincialHealthPlan values (123741, 'BC Resident - MSP', TO_DATE('2018-01-01','YYYY-MM-DD'), TO_DATE('2019-12-31','YYYY-MM-DD'), 34873524);
insert into ProvincialHealthPlan values (120390, 'BC Resident - MSP', TO_DATE('2018-01-01','YYYY-MM-DD'), TO_DATE('2019-12-31','YYYY-MM-DD'), 38475018);
insert into ProvincialHealthPlan values (120391, 'BC Resident - MSP', TO_DATE('2018-01-01','YYYY-MM-DD'), TO_DATE('2019-12-31','YYYY-MM-DD'), 37663542);
insert into ProvincialHealthPlan values (124940, 'BC Resident - MSP', TO_DATE('2018-01-01','YYYY-MM-DD'), TO_DATE('2019-12-31','YYYY-MM-DD'), 31836411);
insert into ProvincialHealthPlan values (128855, 'BC Resident - MSP', TO_DATE('2018-01-01','YYYY-MM-DD'), TO_DATE('2019-12-31','YYYY-MM-DD'), 33545243);
insert into ProvincialHealthPlan values (120040, 'BC Resident - MSP', TO_DATE('2018-01-01','YYYY-MM-DD'), TO_DATE('2019-12-31','YYYY-MM-DD'), 32938452);
insert into ProvincialHealthPlan values (124872, 'BC Resident - MSP', TO_DATE('2018-01-01','YYYY-MM-DD'), TO_DATE('2019-12-31','YYYY-MM-DD'), 39485732);
insert into ProvincialHealthPlan values (120473, 'BC Resident - MSP', TO_DATE('2018-01-01','YYYY-MM-DD'), TO_DATE('2019-12-31','YYYY-MM-DD'), 38573757);
insert into ProvincialHealthPlan values (128371, 'BC Resident - MSP', TO_DATE('2018-01-01','YYYY-MM-DD'), TO_DATE('2019-12-31','YYYY-MM-DD'), 39485722);
insert into ProvincialHealthPlan values (124287, 'BC Resident - MSP', TO_DATE('2018-01-01','YYYY-MM-DD'), TO_DATE('2019-12-31','YYYY-MM-DD'), 34838582);
insert into ProvincialHealthPlan values (127563, 'BC Resident - MSP', TO_DATE('2018-01-01','YYYY-MM-DD'), TO_DATE('2019-12-31','YYYY-MM-DD'), 35835723);
insert into ProvincialHealthPlan values (127544, 'BC Resident - MSP', TO_DATE('2018-01-01','YYYY-MM-DD'), TO_DATE('2019-12-31','YYYY-MM-DD'), 34958324);
insert into ProvincialHealthPlan values (129756, 'BC Resident - MSP', TO_DATE('2018-01-01','YYYY-MM-DD'), TO_DATE('2019-12-31','YYYY-MM-DD'), 33847244);
insert into ProvincialHealthPlan values (129237, 'BC Resident - MSP', TO_DATE('2018-01-01','YYYY-MM-DD'), TO_DATE('2019-12-31','YYYY-MM-DD'), 32838321);
insert into ProvincialHealthPlan values (128776, 'BC Resident - MSP', TO_DATE('2018-01-01','YYYY-MM-DD'), TO_DATE('2019-12-31','YYYY-MM-DD'), 35384852);
insert into ProvincialHealthPlan values (128778, 'BC Resident - MSP', TO_DATE('2018-01-01','YYYY-MM-DD'), TO_DATE('2019-12-31','YYYY-MM-DD'), 38583233);
insert into ProvincialHealthPlan values (124976, 'BC Resident - MSP', TO_DATE('2018-01-01','YYYY-MM-DD'), TO_DATE('2019-12-31','YYYY-MM-DD'), 35294858);
insert into ProvincialHealthPlan values (123311, 'BC Resident - MSP', TO_DATE('2018-01-01','YYYY-MM-DD'), TO_DATE('2019-12-31','YYYY-MM-DD'), 35728495);
...
insert into Invoice values (152748, 31572742, 'Clinic visit', TO_DATE('2018-05-11','YYYY-MM-DD'), TO_DATE('2018-05-11','YYYY-MM-DD'), 'Paid', TO_DATE('2018-11-27','YYYY-MM-DD'), 'Cheque', 0.0, 628462, 128461);
...
insert into Invoice values (138824, 31000000, 'Clinic visit', TO_DATE('2019-02-14','YYYY-MM-DD'), TO_DATE('2019-03-14','YYYY-MM-DD'), 'Unpaid', NULL, NULL, 150.0, NULL, 128471);
insert into Invoice values (139824, 31000000, 'Clinic visit', TO_DATE('2019-02-16','YYYY-MM-DD'), TO_DATE('2019-03-16','YYYY-MM-DD'), 'Unpaid', NULL, NULL, 220.0, NULL, 128471);
insert into Invoice values (137748, 31000000, 'Clinic visit', TO_DATE('2019-02-17','YYYY-MM-DD'), TO_DATE('2019-03-17','YYYY-MM-DD'), 'Unpaid', NULL, NULL, 230.0, NULL, 128471);
insert into Invoice values (122731, 31000000, 'Knee brace', TO_DATE('2019-02-12','YYYY-MM-DD'), TO_DATE('2019-03-12','YYYY-MM-DD'), 'Unpaid', NULL, NULL, 500.0, NULL, 128471);
insert into Invoice values (159837, 31000000, 'ER Visit', TO_DATE('2019-02-15','YYYY-MM-DD'), TO_DATE('2018-03-15','YYYY-MM-DD'), 'Paid', TO_DATE('2019-03-12','YYYY-MM-DD'), 'Credit\Debit', 0.0, 628462, 128471);
insert into Invoice values (129842, 31000000, 'ER Visit', TO_DATE('2019-03-01','YYYY-MM-DD'), TO_DATE('2019-04-01','YYYY-MM-DD'), 'Unpaid', NULL, NULL, 1000.0, NULL, 128471);
insert into Invoice values (185734, 33000000, 'Clinic visit', TO_DATE('2019-02-12','YYYY-MM-DD'), TO_DATE('2019-02-12','YYYY-MM-DD'), 'Unpaid', NULL, NULL, 150.0, NULL, 124324);
insert into Invoice values (158382, 33000000, 'Prescription - Lipitor', TO_DATE('2018-03-15','YYYY-MM-DD'), TO_DATE('2018-04-15','YYYY-MM-DD'), 'Paid', TO_DATE('2019-03-05','YYYY-MM-DD'), 'Credit\Debit', 0.0, 674823, 124324);
insert into Invoice values (151102, 33000000, 'Prescription - Esomeprazole', TO_DATE('2018-03-15','YYYY-MM-DD'), TO_DATE('2018-04-15','YYYY-MM-DD'), 'Paid', TO_DATE('2019-03-05','YYYY-MM-DD'), 'Credit\Debit', 0.0, 674823, 124324);
insert into Invoice values (153847, 33000000, 'Prescription - Fluoxetine', TO_DATE('2018-03-15','YYYY-MM-DD'), TO_DATE('2018-04-15','YYYY-MM-DD'), 'Paid', TO_DATE('2019-03-05','YYYY-MM-DD'), 'Credit\Debit', 0.0, 674823, 124324);
insert into Invoice values (124759, 33000000, 'Clinic visit', TO_DATE('2019-02-25','YYYY-MM-DD'), TO_DATE('2018-03-25','YYYY-MM-DD'), 'Unpaid', NULL, NULL, 200.0, NULL, 124324);
insert into Invoice values (184854, 33000000, 'ER Visit', TO_DATE('2018-10-14','YYYY-MM-DD'), TO_DATE('2018-11-14','YYYY-MM-DD'), 'Paid', TO_DATE('2018-11-15','YYYY-MM-DD'), 'Credit\Debit', 0.0, 682742, 124324);
insert into Invoice values (152745, 34000000, 'Clinic visit', TO_DATE('2019-01-05','YYYY-MM-DD'), TO_DATE('2018-05-11','YYYY-MM-DD'), 'Paid', TO_DATE('2018-11-27','YYYY-MM-DD'), 'Cheque', 0.0, 683743, 128472);
insert into Invoice values (123845, 34000000, 'Prescription - Amoxicillin', TO_DATE('2018-10-11','YYYY-MM-DD'), TO_DATE('2018-11-11','YYYY-MM-DD'), 'Unpaid', NULL, NULL, 37.21, NULL, 128472);
insert into Invoice values (145883, 34000000, 'Chest X-Ray', TO_DATE('2019-03-25','YYYY-MM-DD'), TO_DATE('2019-04-25','YYYY-MM-DD'), 'Unpaid', NULL, NULL, 200.0, NULL, 128472);
insert into Invoice values (123984, 34000000, 'Orthopedic massage', TO_DATE('2019-01-05','YYYY-MM-DD'), TO_DATE('2019-02-05','YYYY-MM-DD'), 'Paid', TO_DATE('2019-01-07','YYYY-MM-DD'), 'Credit\Debit', 0.0, 684732, 128472);
insert into Invoice values (121374, 32000000, 'Prescription - Metformin', TO_DATE('2019-01-05','YYYY-MM-DD'), TO_DATE('2019-02-05','YYYY-MM-DD'), 'Unpaid', NULL, NULL, 45.27, NULL, 124772);
insert into Invoice values (121103, 32000000, 'Prescription - Levothyroxine', TO_DATE('2019-03-25','YYYY-MM-DD'), TO_DATE('2019-04-25','YYYY-MM-DD'), 'Unpaid', NULL, NULL, 33.21, NULL, 124772);
insert into Invoice values (123999, 32000000, 'Prescription - Lisinopril', TO_DATE('2018-10-06','YYYY-MM-DD'), TO_DATE('2018-11-06','YYYY-MM-DD'), 'Paid', TO_DATE('2018-11-30','YYYY-MM-DD'), 'Credit\Debit', 0.0, NULL, 124772);
