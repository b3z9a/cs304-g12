...
public class HealthDBApp {
    ...
    private JPanel panelLabTechnician;
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                if (username.equals("") || password.equals("")) {
                    ...
                    if (hdb.connectToDB()) {
                        ...
                        panelLabTechnician.setVisible(false);
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                switch (userClass) {
                    ...
                    case "LabTechnician":
                        ...
                        panelPharmacist.setVisible(false);
                        panelLabTechnician.setVisible(true);
                        panelPatient.setVisible(false);
                        panelInvoice.setVisible(false);
    ...
    /**
     * Generate the Pharmacist user class view
     */

    /**
     * Generate the LabTechnician user class view
     */

    /**
     * Generate the Patient user class view
     */

    /**
     * Generate the Invoice user class view
     */
